...
git apply --directory=mozilla-unified/security/nss nss-kemtls-patch
...
cd "${ROOTDIR}"
git clone --branch cf-pq-kemtls --depth 1 https://github.com/cloudflare/go cf-pq-kemtls
cd cf-pq-kemtls/src && ./make.bash
